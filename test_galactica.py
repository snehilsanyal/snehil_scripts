...
print(prompt)
# Model path contains pytorch.bin/flaxweights/model.safetensors and tokenizer
...
question = "A paper that introduced a neural network architecture for recognizing digits"
